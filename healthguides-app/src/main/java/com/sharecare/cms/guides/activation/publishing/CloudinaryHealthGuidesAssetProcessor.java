...
@Slf4j
public class CloudinaryHealthGuidesAssetProcessor implements HealthGuideAssetProcessor {

    private final Cloudinary cloudinary;
    private final AssetProvider jcrAssetProvider;

    @Inject
    public CloudinaryHealthGuidesAssetProcessor(CloudinaryClientServiceConnector clientServiceConnector,
