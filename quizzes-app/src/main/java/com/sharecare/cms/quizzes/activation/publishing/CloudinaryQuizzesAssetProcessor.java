...
@Slf4j
public class CloudinaryQuizzesAssetProcessor implements QuizAssetProcessor {

    private final Cloudinary cloudinary;
    private final AssetProvider jcrAssetProvider;

    @Inject
    public CloudinaryQuizzesAssetProcessor(CloudinaryClientServiceConnector clientServiceConnector,
